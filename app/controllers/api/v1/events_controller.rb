module API
  module V1
    class EventsController < APIController
      ...
      def event_params
        p = params.permit(:id, :slug, :name, :start_at, :end_at, :organizer_name, :abstract, :description, :website, :location_id, :location_slug, :series, :event_id, :flyer, :hero, :header).to_h
