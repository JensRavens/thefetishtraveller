    ...
    return (
      <React.Fragment>
        ...
        <Container variant="small">
          ...
          <p>
            <a className="link" href="mailto:contact@thefetishtraveller.com">contact@thefetishtraveller.com</a>
          </p>
