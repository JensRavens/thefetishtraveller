    ...
    return (
      <React.Fragment>
        ...
        <Container variant="small">
          ...
          <p>
            <a className="link" href="mailto:contact@thefetishtraveller.com">
              contact@thefetishtraveller.com
            </a>
          </p>
          ...
          <p>
            ...
            überwachen oder nach Umständen zu forschen, die auf eine
          ...
          <p>
            ...
            Zeitpunkt der Verlinkung auf mögliche Rechtsverstöße überprüft.
          ...
          <p>
            ...
            E-Mail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets
          ...
          <p>
            ...
            möchten, benötigen wir von Ihnen eine E-Mail-Adresse sowie
            Informationen, welche uns die Überprüfung gestatten, dass Sie der
            ...
            Diese Daten verwenden wir ausschließlich für den Versand der
          ...
          <p>
            ...
            können Sie jederzeit widerrufen, etwa über den "Austragen"-Link im
            Newsletter.
          </p>
          ...
          <p>
            ...
            Analyse der Benutzung der Website durch Sie ermöglichen. Die durch
            den Cookie erzeugten Informationen über Ihre Benutzung dieser
          ...
          <p>
            ...
            Mitgliedstaaten der Europäischen Union oder in anderen
            Vertragsstaaten des Abkommens über den Europäischen Wirtschaftsraum
            vor der Übermittlung in die USA gekürzt. Nur in Ausnahmefällen wird
            die volle IP-Adresse an einen Server von Google in den USA
            übertragen und dort gekürzt. Im Auftrag des Betreibers dieser
            Website wird Google diese Informationen benutzen, um Ihre Nutzung
            der Website auszuwerten, um Reports über die Websiteaktivitäten
            ...
            von Ihrem Browser übermittelte IP- Adresse wird nicht mit anderen
          ...
          <p>
            ...
            können darüber hinaus die Erfassung der durch den Cookie erzeugten
          ...
          <p>
            ...
            Datenschutzbehörden bei der Nutzung von Google Analytics vollständig
            um.
          </p>
          <h3>SSL-Verschlüsselung</h3>
          <p>
            Diese Seite nutzt aus Gründen der Sicherheit und zum Schutz der
            Übertragung vertraulicher Inhalte, wie zum Beispiel der Anfragen,
            ...
            Verschlüsselung aktiviert ist, können die Daten, die Sie an uns
            übermitteln, nicht von Dritten mitgelesen werden.
          </p>
          <h3>Recht auf Auskunft, Löschung, Sperrung</h3>
          <p>
            ...
            Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu
